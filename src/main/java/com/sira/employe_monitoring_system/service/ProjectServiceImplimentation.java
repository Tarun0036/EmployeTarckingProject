...
//			user.setNameOfOrganization(userDto.getNameOfOrganization());
//			user.setEmail(userDto.getEmail());
//			user.setContact(userDto.getContact());
//			user.setLocationOfOrganization(userDto.getLocationOfOrganization());
//			user.setCountry(userDto.getCountry());
//			user.setNoOfEmp(userDto.getNoOfEmp());
//			repo.save(user);
//			return true;
//		}
//		return false;
...
//		
//		if(list.iterator().next().isDeleted())
//		{
//			return null;
//		}
//		else
